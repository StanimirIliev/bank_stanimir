...
class DepositQueryTest {
    ...
    fun setUp() {
        ...
        port(port)
        post("/v1/executeDeposit", DepositRoute(
                sessionRepository,
                accountRepository,
    ...
    fun executeDepositAsAuthorizedUser() {
        ...
        val request = HttpPost("http://$domain:$port/v1/executeDeposit")
        ...
        assertThat(responseContent, `is`(equalTo("{\"msg\":\"Deposit successful.\"}")))
        assertThat(accountRepository.getAccount(accountId)!!.balance, `is`(equalTo(50f)))
    }
    ...
    fun tryToExecuteDepositAsUnauthorizedUser() {
        ...
        assertThat(responseContent, `is`(equalTo("{\"msg\":\"Cannot execute this deposit. Access denied.\"}")))
        assertThat(accountRepository.getAccount(accountId)!!.balance, `is`(equalTo(0f)))
    }
    ...
    fun tryToExecuteDepositWithoutPassingParameter() {
        ...
        assertThat(responseContent, `is`(equalTo("{\"msg\":\"Cannot execute this deposit. No account id or " +
