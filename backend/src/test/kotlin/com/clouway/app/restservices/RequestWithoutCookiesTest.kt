package com.clouway.app.restservices
...
import com.clouway.app.restservices.get.UsernameQueryTest
...
class RequestWithoutCookiesTest {
    ...
    @Test
    fun tryToRequestQueryWithoutSessionIdCookie() {
        ...
        Assert.assertThat(response.statusLine.statusCode, `is`(CoreMatchers.equalTo(HttpStatus.BAD_REQUEST_400)))
        Assert.assertThat(responseContent, `is`(equalTo("{\"msg\":\"Error occurred while getting the " +
                "cookie sessionId\"}")))
    }
}