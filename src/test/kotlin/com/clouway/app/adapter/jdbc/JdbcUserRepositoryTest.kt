...
class JdbcUserRepositoryTest {
    ...
    fun getBalanceOfUserWithCorrectCredentials() {
        ...
        assertThat(userRepository.getBalance("user123", "password789", false), `is`(equalTo(0f)))
    }

    @Test
    fun tryToGetBalanceOfUserWithWrongCredentials() {
        assertThat(userRepository.getBalance("user123", "password789", false), `is`(nullValue()))
    }
}